...
ax.scatter(rw.x_value, rw.y_valye, c=point_number, cmap=plt.cm.Blues, edgecolors="none", s=1) # type: ignore
# stessa spaziatura delle tacche
ax.set_aspect("equal")
# il primo punto (0,0) è verde e più grande 
ax.scatter(0,0,c="green",edgecolors="none", s=100)
# l'ultimo punto è rosso e più grande
ax.scatter(rw.x_value[-1],rw.y_valye[-1], c="red",edgecolors="none", s=100)
# eliminare gli assi
